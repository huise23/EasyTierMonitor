...
$solutionPath = "C:\work\ping1\TailscaleMonitor\TailscaleMonitor.sln"

Write-Host "========================================"  -ForegroundColor Cyan
Write-Host "Building TailscaleMonitor Plugin" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "========================================" -ForegroundColor Green
    Write-Host ""
    Write-Host "Output: bin\x64\Release\TailscaleMonitor.dll" -ForegroundColor Yellow
    Write-Host ""
} else {
    Write-Host ""
