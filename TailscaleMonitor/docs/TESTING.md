# TailscaleMonitor Plugin Testing Guide
...
1. Copy the DLL to TrafficMonitor plugins directory:
   ```
   copy "C:\work\ping1\TailscaleMonitor\bin\x64\Release\TailscaleMonitor.dll" "C:\Program Files\TrafficMonitor\plugins\"
   ```
...
```
C:\Users\[username]\AppData\Roaming\TrafficMonitor\TailscaleMonitor_debug.log
```
