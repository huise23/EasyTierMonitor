# Tailscale Monitor Plugin - 实现进度

## 项目概述

TrafficMonitor 插件，用于实时监控 Tailscale peer 的连接状态、延迟和流量信息。
...
输出：`bin\x64\Release\TailscaleMonitor.dll`
...
- [开发计划](.omc/plans/tailscale-monitor-plugin.md)
