# TailscaleMonitor - Debug Version
...
- **File**: `tailscale_monitor_debug.log`
...
1. **Replace the DLL**
   - Copy `bin\x64\Release\TailscaleMonitor.dll` to TrafficMonitor plugins folder
...
3. **Check the Debug Log**
   - Look for `tailscale_monitor_debug.log` in:
...
**Check**: Does `tailscale_monitor_debug.log` exist?
...
```
[INFO] Config loaded: cli_path=tailscale, selected_peer_id=peer123, update_interval=5
```
